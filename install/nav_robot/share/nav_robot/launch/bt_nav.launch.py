...
def generate_launch_description():
    ...
    bt_xml = os.path.join(pkg_nav, 'behaviour_tree', 'task_bt.xml')
    ...
    # bt_plugin_node = Node(
    #     package='nav_robot',
    #     executable='bt_plugin_node',
    #     name='bt_plugin_node',
    #     output='screen',
    #     parameters=[{
    #         'use_sim_time': True,
    #         'poses_file': os.path.join(pkg_nav, 'config', 'poses.yaml')
    #     }]
    # )
